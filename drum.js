const drumPads = [
  ...
  class DrumPad extends React.Component {
    ...
    render() {
      return /*#__PURE__*/(
        React.createElement("div", { className: "drum-pad col-xs-4", id: this.props.padId, onClick: this.handleClick, style: { backgroundColor: this.state.bgcolor ? this.props.padColor1 : this.props.padColor2 } },
        this.props.keyName, /*#__PURE__*/
        React.createElement("audio", { className: "clip", id: this.props.keyName, src: this.props.link })));
  ...
  class Drum extends React.Component {
    ...
    render() {
      const drumPadsHtml = drumPads.map(v => /*#__PURE__*/React.createElement(DrumPad, { padId: v.padId, keyName: v.keyName, link: v.link, padColor1: v.padColor1, padColor2: v.padColor2, display: v.display }));
      return /*#__PURE__*/(
        React.createElement("div", { id: "drum-machine" }, /*#__PURE__*/
        React.createElement("div", { id: "display" }, "Let's Rock!"), /*#__PURE__*/

        React.createElement("div", { className: "row" }, drumPadsHtml)));


    }}
  ;
  ReactDOM.render( /*#__PURE__*/React.createElement(Drum, null), document.getElementById("root"));
